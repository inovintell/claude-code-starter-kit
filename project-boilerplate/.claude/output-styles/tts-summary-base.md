...
2. Add the heading: `## Audio Summary for P.`
3. Craft a message that speaks DIRECTLY to P. about what you did for them
...
- **Address P. directly** when appropriate: "P., I've updated your..." or "Fixed the bug in..." 
- **Focus on outcomes** for the user: what they can now do, what's been improved
- **Be conversational** - speak as if telling P. what you just did
...
P., I've created three new output styles to customize how you receive information.

```bash
uv run .claude/hooks/utils/tts/elevenlabs_tts.py "P., I've created three new output styles to customize how you receive information."
```
